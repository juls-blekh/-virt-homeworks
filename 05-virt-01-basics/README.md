...
Виртуализации на основе ОС подразумевает наличие хостовой ОС, на функционал ядра которой будут опираться контейнеры. Контейнеры более легковесны, чем виртуальные машины при аппаратной виртуализации, т.к. им не требуется взаимодействовать с аппаратным обеспечением.
